                ...
                /* WEBPACK VAR INJECTION */ (function (global) {
                    ...
                    Cleave.prototype = {
                        ...
                        onInput: function (value) {
                            ...
                            if (pps.date) {
                                value =
                                    pps.dateFormatter.getValidatedDate(value);
                            }
                        ...
                        updateCreditCardPropsByValue: function (value) {
                            ...
                            if (pps.creditCardType !== creditCardInfo.type) {
                                ...
                                pps.onCreditCardTypeChanged.call(
                                    owner,
                                    pps.creditCardType
                                );
                            }
            ...
            /***/ function (module, exports) {
                ...
                PhoneFormatter.prototype = {
                    ...
                    format: function (phoneNumber) {
                        ...
                        for (
                            var i = 0, iMax = phoneNumber.length;
                            i < iMax;
                            i++
                        ) {
                ...
                /* WEBPACK VAR INJECTION */ (function (global) {
                    ...
                    var DefaultProperties = {
                        ...
                        assign: function (target, opts) {
                            ...
                            target.creditCardStrictMode =
                                !!opts.creditCardStrictMode;
                            ...
                            target.phoneRegionCode =
                                opts.phoneRegionCode || "AU";
                            ...
                            target.numeralIntegerScale =
                                opts.numeralIntegerScale > 0
                                    ? opts.numeralIntegerScale
                                    : 0;
                            target.numeralDecimalScale =
                                opts.numeralDecimalScale >= 0
                                    ? opts.numeralDecimalScale
                                    : 2;
                            target.numeralDecimalMark =
                                opts.numeralDecimalMark || ".";
                            target.numeralThousandsGroupStyle =
                                opts.numeralThousandsGroupStyle || "thousand";
                            target.numeralPositiveOnly =
                                !!opts.numeralPositiveOnly;
                            target.stripLeadingZeroes =
                                opts.stripLeadingZeroes !== false;
                            ...
                            target.prefix =
                                target.creditCard || target.date
                                    ? ""
                                    : opts.prefix || "";
                            target.noImmediatePrefix = !!opts.noImmediatePrefix;
                            target.prefixLength = target.prefix.length;
                            target.rawValueTrimPrefix =
                                !!opts.rawValueTrimPrefix;
                            target.copyDelimiter = !!opts.copyDelimiter;

                            target.initValue =
                                opts.initValue !== undefined &&
                                opts.initValue !== null
